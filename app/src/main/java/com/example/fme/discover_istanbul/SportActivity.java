...
public class SportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteDatabase.KitapEkle(new Sport("Calikusu","Resa nuri guntekin","Futbol"));
        sqLiteDatabase.KitapEkle(new Sport("Calik","Resa nuri gtekin","Basketbol"));
        sqLiteDatabase.KitapEkle(new Sport("Calkus","Resa nuri gntekin","Futbol"));
        sqLiteDatabase.KitapEkle(new Sport("Cakusu","Resa nuguntekin","Basketbol"));
        list = sqLiteDatabase.futbolGetir();
